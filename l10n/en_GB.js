OC.L10N.register(
    ...
    "Appointment is canceled" : "Appointment is canceled",
    ...
    "Your appointment scheduled for %s is canceled." : "Your appointment scheduled for %s is canceled.",
    ...
    "Action failed. Select calendar(s) first." : "Action failed. Select calendar(s) first.",
    "More than 2 additional pages (10 maximum)" : "More than 2 additional pages (10 maximum)",
    "Page not added: 10 pages maximum" : "Page not added: 10 pages maximum",
    "Please setup the directory page first." : "Please setup the directory page first.",
    "Directory page" : "Directory page",
    "Can't find Talk app. Is it installed and enabled ?" : "Cannot find Talk app. Is it installed and enabled ?",
    ...
    "Directory Page" : "Directory Page",
    "Settings" : "Settings",
    "Manage Appointment Slots" : "Manage Appointment Slots",
    "User/Organization Info" : "User/Organization Info",
    "Auto Style" : "Auto Style",
    "Help/Tutorial" : "Help/Tutorial",
    "Public Page URL" : "Public Page URL",
    "Close" : "Close",
    ...
    "Discard" : "Discard",
    "Save" : "Save",
    "Hint: right-click on appointment to edit." : "Hint: right-click on appointment to edit.",
    "Time zone" : "Time zone",
    "Remove All" : "Remove All",
    "Copy to Next" : "Copy to Next",
    "Adding appointment to {calendarName} calendar …" : "Adding appointment to {calendarName} calendar …",
    "All appointments have been added to {calendarName} calendar." : "All appointments have been added to {calendarName} calendar.",
    "Error occurred. Check console …" : "Error occurred. Check console …",
    "Preview" : "Preview",
    "New Settings Applied." : "New Settings Applied.",
    "Fetching URL from the server …" : "Fetching URL from the server …",
    "Cannot get public URL from server" : "Cannot get public URL from server",
    "Public link copied to clipboard" : "Public link copied to clipboard",
    "Copy Error" : "Copy Error",
    "Public Page" : "Public Page",
    "Loading" : "Loading",
    "Apply" : "Apply",
    "Multiple public pages available" : "Multiple public pages available",
    "Main page" : "Main page",
    ...
    "These settings affect ALL pages" : "These settings affect ALL pages",
    ...
    "Mark the appointment as canceled" : "Mark the appointment as canceled",
    ...
    "8 Hours" : "8 Hours",
    "12 Hours" : "12 Hours",
    "External Mode Settings" : "External Mode Settings",
    "Optimize recurrence" : "Optimize recurrence",
    "Require \"Appointment\" category" : "Require \"Appointment\" category",
    "Auto-fix \"Source\" timeslots" : "Auto-fix \"Source\" timeslots",
    "Debugging" : "Debugging",
    "Loading…" : "Loading…",
    ...
    "Directory Page Settings" : "Directory Page Settings",
    "Add, remove and edit directory page links" : "Add, remove and edit directory page links",
    "Edit" : "Edit",
    "Title" : "Title",
    "Subtitle" : "Subtitle",
    "Text" : "Text",
    ...
    "Error" : "Error",
    "Title and URL cannot be empty" : "Title and URL cannot be empty",
    ...
    "Public Page Settings" : "Public Page Settings",
    ...
    "Customize and configure the app" : "Customize and configure the app",
    "Customize Public Page" : "Customize Public Page",
    ...
    "Customize email text:" : "Customize email text:",
    "Chat/Call link:" : "Chat/Call link:",
    "Add \"Meeting Type\" form field" : "Add \"Meeting Type\" form field",
    "Label text:" : "Label text:",
    "Placeholder text:" : "Placeholder text:",
    "\"In-person\" option text:" : "\"In-person\" option text:",
    "\"Online\" option text:" : "\"Online\" option text:",
    "Type change email text:" : "Type change email text:",
    "See documentation …" : "See documentation …",
    "\"Meeting type\" form field." : "\"Meeting type\" form field.",
    "Warning" : "Warning",
    "Guest will be placed in the lobby until you allow access to the Room manually via Talk app side menu." : "Guest will be placed in the lobby until you allow access to the Room manually via Talk app side menu.",
    ...
    "Time slot mode has changed. Public page is going offline …" : "Time slot mode has changed. Public page is going offline …",
    "Main calendar is required" : "Main calendar is required",
    "Source calendar is required" : "Source calendar is required",
    "Destination calendar is required" : "Destination calendar is required",
    "Source and Destination calendars must be different" : "Source and Destination calendars must be different",
    ...
    "Gathering calendar information" : "Gathering calendar information",
    ...
    "Number of expired appointments/slots: " : "Number of expired appointments/slots: ",
    "Cannot get calendar data" : "Cannot get calendar data",
    ...
    "Form header and event organizer settings" : "Form header and event organizer settings",
    "Name:" : "Name:",
    "Email:" : "Email:",
    "Location:" : "Location:",
    "Phone:" : "Phone:",
