OC.L10N.register(
    ...
    "Dear %s," : "Bäste %s,",
    "Reminder: please confirm your %s appointment" : "Påminnelse: Var vänlig bekräfta din bokning med %s",
    "_Important: If not confirmed within %n hour, this appointment will be automatically cancelled._::_Important: If not confirmed within %n hours, this appointment will be automatically cancelled._" : ["Viktigt: Om du inte bekräftar din bokning inom %n timme kommer detta möte automatiskt ställas in.","Viktigt: Om du inte bekräftar din bokning inom %n timmar kommer detta möte automatiskt ställas in."],
