OC.L10N.register(
    ...
    "Booked via %s Appointments" : "Über %s-Terminvereinbarung gebucht",
    ...
    "CreatePage warning. Check logs." : "CreatePage Warnung. Protokolle prüfen.",
    "DeletePage warning. Check logs." : "DeletePage Warnung. Protokolle prüfen.",
    ...
    "System Native Sync" : "Systemnative Synchronisierung",
    "1 Hour" : "1 Stunde",
    "2 Hours" : "2 Stunden",
    "4 Hours" : "4 Stunden",
    "8 Hours" : "8 Stunden",
    ...
    "Page Tag" : "Schlagwort für die Seite",
    ...
    "For example template like {tokens} will set new appointments title to something like John Smith (Good Org)" : "Zum Beispiel wird die Vorlage wie {tokens} den Titel neuer Termine auf etwas wie John Smith (Good Org) setzen",
    ...
    "When linked (subscription) calendars are selected for conflict check, the Appointments app can pull data from remote servers before checking for scheduling conflicts. It is impractical to pull the data on every request, as this would increase processing time, especially if multiple remote calendars are selected. Your calendar system has a cache synchronization mechanism to facilitate timely updates. This option is provided just in case you feel that the data is not refreshed often enough." : "Wenn verknüpfte (Abonnement-)Kalender für die Konfliktprüfung ausgewählt werden, kann die Termine-App Daten von Remote-Servern abrufen, bevor sie auf Planungskonflikte prüft. Es ist unpraktisch, die Daten bei jeder Anfrage abzurufen, da dies die Verarbeitungszeit verlängern würde, insbesondere wenn mehrere Remote-Kalender ausgewählt werden. Ihr Kalendersystem verfügt über einen Cache-Synchronisierungsmechanismus, um zeitnahe Aktualisierungen zu ermöglichen. Diese Option wird nur für den Fall bereitgestellt, dass Sie das Gefühl haben, dass die Daten nicht oft genug aktualisiert werden.",
    "External Mode" : "Externer Modus",
    "Optimize recurrence" : "Wiederholungen optimieren",
    "If recurrent events are used in the \"Source Calendar\" the start (DTSTART) date will be pushed forward once in a while in order to improve performance." : "Wenn wiederkehrende Ereignisse im \"Quellenkalender\" verwendet werden, wird das Startdatum (DTSTART) gelegentlich vorgeschoben, um die Leistung zu verbessern.",
    ...
    "Settings Dump" : "Einstellungs-Dump",
    ...
    "When you create new appointment slots they are placed here and are shown in your public page(s). It is recommended to use a dedicated calendar." : "Wenn Sie neue Terminslots erstellen, werden sie hier platziert und in Ihren öffentlichen Seite(n) angezeigt. Es wird empfohlen, einen dedizierten Kalender zu verwenden.",
    ...
    "These calendars will be checked for conflicting events in addition to the Destination Calendar." : "Diese Kalender werden auf konfliktierende Ereignisse überprüft, zusätzlich zum Zielkalender.",
    "Name/Organization" : "Name/Organisation",
    "Set to User Profile email" : "Auf Benutzerprofil-E-Mailadresse setzen",
    "Organizer Email" : "Organisator E-Mail",
    "Location" : "Ort",
    "Phone" : "Telefon",
    "Attach .ics file to confirm/cancel emails" : "Füge eine .ics-Datei an Bestätigung/Absage an",
    "An .ics attachment will automatically be generated for notification emails, allowing better integration with email/calendar apps that support it." : "Ein .ics-Anhang für Benachrichtigungs-E-Mails wird automatisch generiert, um eine bessere Integration mit E-Mail/Kalender-Apps, die dies unterstützen, zu ermöglichen.",
    "Email Attendee when the appointment is:" : "Erstelle eine E-Mail an Teilnehmer, wenn der Termin stattfindet:",
    "Attendees will be notified via email when their upcoming appointments are updated or deleted in the calendar app or through some other external mechanism. Only changes to Date/Time, Status, or Location will trigger the \"Modified\" notification." : "Die Teilnehmer werden per E-Mail benachrichtigt, wenn ihre bevorstehenden Termine in der Kalender-App geändert oder gelöscht werden oder über einen anderen externen Mechanismus. Nur Änderungen an Datum/Zeit, Status oder Ort lösen die \"Geändert\"-Benachrichtigung aus.",
    ...
    "Additional reminder email text" : "Zusätzlicher E-Mail-Text für Erinnerungen",
    ...
    "You can override default email message. There are two tokens available, {token1} and if you use password protection {token2}, they will be replaced with the rooms URL and the password if used. Example:" : "Sie können die Standard-E-Mail-Nachricht überschreiben. Es stehen zwei Tokens zur Verfügung, {token1} und wenn Sie Passwortschutz verwenden {token2}, werden sie durch die URL des Raums und das Passwort, falls verwendet, ersetzt. Beispiel:",
    "Add 'Meeting Type' form field" : "Formularfeld \"Besprechungstyp\" hinzufügen",
    "When this option is enabled, a \"select\" drop-down will be added to the form with a choice of \"In-person\" or \"Online (audio/video)\". If a visitor selects an \"In-person\" meeting, a Talk room for this appointment will NOT be created." : "Wenn diese Option aktiviert ist, wird dem Formular ein \"Auswählen\" Dropdown-Menü mit der Auswahlmöglichkeit \"Persönlich\" oder \"Online (Audio/Video)\" hinzugefügt. Wenn ein Besucher ein \"Persönlich\" Meeting auswählt, wird kein Talk Raum für diesen Termin erstellt.",
    ...
    "If this field is not empty and has two tokens {token1} (can contain any text) and {token2} (MUST be new_type), then this text will be attached to the email and attendees will be able to switch their meeting type simply by clicking the link {token}. Example:" : "Wenn dieses Feld nicht leer ist und zwei Tokens {token1} (kann beliebigen Text enthalten) und {token2} (MUSS new_type sein) enthält, wird dieser Text an die E-Mail angehängt und die Teilnehmer können ihren Meeting-Typ einfach durch Klicken auf den Link {token} ändern. Beispiel:",
