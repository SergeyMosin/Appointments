OC.L10N.register(
    ...
    "Your %1$s appointment scheduled for %2$s is now canceled." : "Ihr für %2$s geplanter %1$s-Termin wurde abgesagt.",
    ...
    "Status: Pending confirmation" : "Status: Ewarte Bestätigung",
    ...
    "Appointment is canceled" : "Der Termin ist abgesagt",
    "%s Appointment" : "%s-Termin",
    "Password" : "Passwort",
    "Chat/Call link: %s" : "Ihr Link zu Chat/Anruf: %s",
    "An email with additional details is on its way to you at %s" : "Eine E-Mail mit weiteren Einzelheiten ist auf dem Weg in ihr Postfach: %s",
    ...
    "Please add time slots first." : "Bitte zuerst ein Zeitfenster hinzufügen.",
    ...
    "Action failed. Select calendar(s) first." : "Aktion fehlgeschlagen. Wählen Sie zuerst den/die Kalender aus.",
    ...
    "Public Page URL" : "URL der öffentlichen Seite (Um Termine zu buchen)",
    "Close" : "Schließen",
    ...
    "Discard" : "Verwerfen",
    "Save" : "Speichern",
    "Hint: right-click on appointment to edit." : "Tipp: Klicken Sie mit der rechten Maustaste auf den Termin, um ihn zu bearbeiten.",
