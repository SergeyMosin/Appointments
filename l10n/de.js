OC.L10N.register(
    ...
    "Dear %s," : "Hallo %s,",
    "Reminder: please confirm your %s appointment" : "Zur Erinnerung: Bitte bestätige deinen %s-Termin",
    ...
    "This is a reminder from %1$s about your upcoming appointment on %2$s. If you need to reschedule, please write to %3$s." : "Dies ist eine Erinnerung von %1$s an deinen bevorstehenden Termin am %2$s. Wenn du den Termin verschieben musst, schreibe bitte %3$s an.",
    "Confirm" : "Bestätigen",
    "Cancel" : "Absagen",
    "Reminder sent on %s" : "Erinnerung gesendet am %s",
    "Cancellation reminder sent on %s" : "Absageerinnerung gesendet am %s",
    ...
    "Guest Email" : "Gast E-Mail-Adresse",
    "%s Appointment Guest Invitation" : "%s Termin Gästeeinladung",
    "%1$s has invited you to join an appointment with %2$s on %3$s. If you have any questions, please email %1$s directly at %4$s" : "%1$s hat dich zu einem Termin mit %2$s am %3$s eingeladen. Wenn du Fragen hast, sende bitte %1$s eine E-Mail an %4$s",
    ...
    "We regret to inform you that your email address has been blocked due to activity that violates our community guidelines." : "Wir bedauern, dir mitteilen zu müssen, dass deine E-Mail-Adresse aufgrund von Aktivitäten, die gegen unsere Community-Richtlinien verstoßen, gesperrt wurde.",
    ...
    "Create Page warning. Check logs." : "Warnung beim Erstellen der Seite. Prüfe die Protokolle.",
    "Delete Page warning. Check logs." : "Warnung beim Löschen der Seite. Prüfe die Protokolle.",
    "Please add at least one directory item first." : "Bitte füge zuerst mindestens einen Verzeichniseintrag hinzu.",
    ...
    "Main calendar not found, check settings." : "Hauptkalender nicht gefunden, prüfe die Einstellungen.",
    "More than 2 additional calendars." : "Mehr als 2 zusätzliche Kalender.",
    "Unconfirmed appointments cancellation reminders" : "Erinnerungen an die Absage unbestätigter Termine",
    ...
    "Please select or create a page" : "Bitte wähle eine Seite aus oder erstelle eine Seite",
    "Preview" : "Vorschau",
    ...
    "Simple Mode: Support Ending Soon" : "Einfacher Modus: Unterstützung endet bald",
    "Stop sharing (disable)" : "Freigabe beenden (deaktivieren)",
    ...
    "Show iframe/embeddable" : "Iframe/Einbettungscode anzeigen",
    "Copy" : "Kopieren",
    "Visit" : "Besuche",
    ...
    "For example template like {tokens} will set new appointments title to something like \"John Smith (Good Org)\"" : "Eine Vorlage wie {tokens} setzt beispielsweise den Titel neuer Termine auf etwas wie \"John Smith (Good Org)\"",
    ...
    "Debug Cancellations" : "Fehler beheben für Absagen",
    ...
    "Check Hash Table" : "Hash-Tabelle prüfen",
    "Create video rooms for confirmed appointments" : "Videoräume für bestätigte Termine erstellen",
    "Delete when appointments are removed" : "Löschen, wenn Termine entfernt werden",
    ...
    "Booked appointment buffers" : "Puffer für gebuchte Termine",
    ...
    "error: cannot find calendar with ID " : "Fehler: Konnte keinen Kalender finden mit der ID ",
    "Main calendar" : "Hauptkalender",
    "When you create new appointment slots they are placed here and are shown in your public page(s). It is recommended to use a dedicated calendar." : "Wenn du neue Terminslots erstellst, werden diese hier platziert und in deinen öffentlichen Seiten angezeigt. Es empfiehlt sich, hierzu einen dedizierten Kalender zu verwenden.",
    ...
    "Location" : "Ort",
    "Phone" : "Telefon",
    "No auto-cancel" : "Keine automatische Absage",
    "24 hours" : "24 Stunden",
    "48 hours" : "48 Stunden",
    "96 hours" : "96 Stunden",
    ...
    "Auto-cancel unconfirmed appointments after" : "Unbestätigte Termine automatisch absagen nach",
    "Send a reminder before canceling" : "Vor der Absage eine Erinnerung senden",
    ...
    "However, if you need to include both the checkbox and HTML or a link to your privacy policy you should separate it from the \"label\" element, and the \"for\" attribute of the \"label\" MUST be set to \"appt_gdpr_id.\" For example:" : "Allerdings, wenn du sowohl das Kontrollkästchen und HTML oder einen Link zu einer Datenschutzerklärung einfügen musst, solltest Du es vom \"label\"-Element trennen, und das \"for\"-Attribut des \"label\" MUSS auf \"appt_gdpr_id\" gesetzt sein. Zum Beispiel:",
    ...
    "You can pre-fill fields in the form by adding a URL query parameter, example:" : "Du kannst Felder im Formular vorab ausfüllen, indem du einen URL-Abfrageparameter hinzufügst. Beispiel:",
    "Prefilled Inputs Appearance" : "Aussehen der vorab ausgefüllten Eingaben",
    "Style Override" : "Stil überschreiben",
    "Insert custom \"style\" element to override default page style. Try something like this for example:" : "Füge ein benutzerdefiniertes \"style\"-Element ein, um den Standardseitenstil zu überschreiben. Versuche zum Beispiel folgendes:",
    ...
    "hCaptcha site key" : "hCaptcha-Webseitenschlüssel",
    ...
    "Custom \"Meeting type\" form fields." : "Benutzerdefinierte \"Besprechungstyp\" Formularfelder.",
    ...
    "You can override default email message. There are two tokens available, {token1} and if you use password protection {token2}, they will be replaced with the rooms URL and the password if used. Example:" : "Du kannst die Standard-E-Mail-Nachricht überschreiben. Es stehen zwei Token zur Verfügung, {token1} und bei Verwendung des Passwortschutzes {token2}. Die Token werden durch die URL des Raums und, sofern verwendet, das Passwort, ersetzt. Beispiel:",
    ...
    "Email and Notifications" : "E-Mail und Benachrichtigungen",
    ...
    "Verifying key" : "Überprüfe Schlüssel",
    ...
    "Invalid number of appointments" : "Ungültige Anzahl an Terminen",
    "Add to Calendar" : "Zum Kalender hinzufügen",
    "Discard" : "Verwerfen",
    "Hint: right-click on an appointment to edit." : "Tipp: Klicken mit der rechten Maustaste auf den Termin, um ihn zu bearbeiten.",
    "Time zone" : "Zeitzone",
    ...
    "Can't delete page. Check console" : "Seite kann nicht gelöscht werden. Konsolenausgabe überprüfen",
    ...
    "Please try again later" : "Bitte später noch einmal versuchen."
},
