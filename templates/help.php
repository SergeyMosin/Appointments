<div class="srgdev-appt-hs-inner">
    ...
    <h2 class="srgdev-appt-hs-h1">3. Generate a Schedule or Add Appointments Manualy</h2>
    <p class="srgdev-appt-hs-p">To add an appointment manually add a calendar event and set status to <strong>TENTATIVE</strong>, category to <strong>Appointment</strong> and time zone to <strong>floating</strong>.</p>
