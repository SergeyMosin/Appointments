<div class="srgdev-appt-hs-inner">
    ...
    <p class="srgdev-appt-hs-p"><strong>Timezone Options:</strong></p>
    <p class="srgdev-appt-hs-p"><span style="text-decoration: underline">Local (floating)</span> - this option should be used if you are booking appointments for real location, like an office or a store. "Floating" values are not bound to any time zone in particular, and will represent the same hour, minute, and second value regardless of which time zone is currently being observed.</p>
    ...
    <p class="srgdev-appt-hs-p" style="font-style: italic">This options mostly effect the .ics file attached to confirmation email. Also, Gnome Calendar does not like "floating" timezones.</p>
    <h2 class="srgdev-appt-hs-h1">4. Share the Public Link</h2>
    ...
    <h2 class="srgdev-appt-hs-h1">5. Check Status in the Calendar</h2>
