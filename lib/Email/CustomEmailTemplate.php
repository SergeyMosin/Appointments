 ...
 *
 * OCC COMMAND:
 *  sudo -u www-data php occ config:system:set mail_template_class --value 'OCA\Appointments\Email\CustomEmailTemplate'
 *
 */
...
!!!! CUSTOM EMAIL TEMPLATE TEST (BODY) !!!!
